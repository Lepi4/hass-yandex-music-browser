...
========================================
FORK: Исправлены моменты, непозволяющие запуститься интеграции на HA 2025.11 или новее
...
1. Добавьте новый произвольный репозиторий:
   ...
   1. Введите ссылку на репозиторий: `https://github.com/lavalex2003/hass-yandex-music-browser`
